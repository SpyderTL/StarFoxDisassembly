	...
	;Unknown data
	DB $FF,$FF,$FF,$FF,$FF,$FF,$FF,$00,$00,$00,$04,$40,$00,$60,$3C,$60
	DB $B3,$7B,$B3,$96,$B3,$B1,$B3,$CC,$B3,$6F,$BF,$6F,$BF,$19,$C7,$19
	DB $C7,$BE,$CD,$19,$C7,$BE,$CD,$19,$C7,$BE,$CD,$19,$C7,$BE,$CD,$D9
	DB $CD,$ED,$D1,$D9,$CD,$ED,$D1,$D9,$CD,$ED,$D1,$D9,$CD,$ED,$D1,$D9
	DB $CD,$ED,$D1,$D9,$CD,$ED,$D1,$8F,$DB,$43,$DC,$5E,$DC,$DC,$DC,$90
	DB $29,$60,$B3
	;Waves
